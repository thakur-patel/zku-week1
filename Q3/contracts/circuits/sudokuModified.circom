...
template sudoku() {
    ...
    component rangeProofPuzzle[9][9];
    component rangeProofSolution[9][9];
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            rangeProofPuzzle[i][j] = RangeProof(32);
            rangeProofPuzzle[i][j].range[0] <== 0;
            rangeProofPuzzle[i][j].range[1] <== 9;
            rangeProofPuzzle[i][j].in <== puzzle[i][j];
            rangeProofPuzzle[i][j].out === 1;
            ...
            rangeProofSolution[i][j] = RangeProof(32);
            rangeProofSolution[i][j].range[0] <== 0;
            rangeProofSolution[i][j].range[1] <== 9;
            rangeProofSolution[i][j].in <== solution[i][j];
            rangeProofSolution[i][j].out === 1;
