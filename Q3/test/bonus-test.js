...
describe("RangeProof circuit test", function () {
    this.timeout(100000000);

    it("Circuit Test - Correct Input", async () => {
        ...
        assert(Fr.eq(Fr.e(witness[1]),Fr.e(1))); // 1 for Right Input

    });

    it("Circuit Test - Wrong Input", async () => {
        ...
        assert(Fr.eq(Fr.e(witness[0]),Fr.e(1)));
        assert(Fr.eq(Fr.e(witness[1]),Fr.e(0))); // 0 for Wrong Input
