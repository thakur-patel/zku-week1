...
snarkjs zkey export verificationkey Multiplier3/circuit_0000.zkey Multiplier3/verification_key.json

# generate solidity contract
# snarkjs zkey export solidityverifier Multiplier3/circuit_final.zkey ../Multiplier3Verifier_plonk.sol
snarkjs zkey export solidityverifier Multiplier3/circuit_0000.zkey ../Multiplier3Verifier_plonk.sol
